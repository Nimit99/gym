<%-- 
    Document   : bodybuilderbmi
    Created on : 2 Oct, 2020, 11:58:19 AM
    Author     : Nimit Tolia
--%>
...
<html>
    ...
    <body>
        <%
           ...
           stmt.executeUpdate();
            if(c<25){
                RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/bodybuilder1.jsp");
            dispatcher.include(request, response); 
            }
            else{
                RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/bodybuilder2.jsp");
            dispatcher.include(request, response); 
            }
