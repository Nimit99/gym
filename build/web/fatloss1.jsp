<%-- 
    Document   : fatloss1
    Created on : 29 Sep, 2020, 8:02:27 PM
    Author     : Nimit Tolia
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="text-uppercase section-heading">Fatloss 1 Schedule</h2>
                    ...
                    <h3 class="section-subheading text-muted">
                        <% 
                                            Float bmi=(Float)session.getAttribute("b"); 
                                             out.print("Your body type is Normal as your BMI Is "+bmi+".");
                                          %> 
                    </h3>
                </div>
            </div>
...
<!--                                    <h2 align="center">
                                        <font>
                                            <strong>Retrieve data from database in jsp</strong>
                                        </font>
                                    </h2>-->
 
                                    <ul class="list-unstyled">
                                        <li>Exercise For You</li>
...
<!--                                            <td><b>pageno</b></td>
                                        ...
                                        String sql ="SELECT * FROM exercise where weekday = 'mon'";
...
<!--                                            <td><%=resultSet.getString("pageno") %></td>
                                            <td><%=resultSet.getString("weekday") %></td>-->
<!--                                            <td><input type="text" value="<%=resultSet.getString("exercise") %>"></td>-->
...
<!--                                            <td><b>pageno</b></td>
                                        ...
                                        String sql ="SELECT * FROM exercise where weekday = 'tue'";
...
<!--                                            <td><%=resultSet2.getString("pageno") %></td>
                                            <td><%=resultSet2.getString("weekday") %></td>-->
                                          
                                            <td><%=resultSet2.getString("exercise") %></td>
...
<!--                                            <td><b>pageno</b></td>
                                        ...
                                        String sql ="SELECT * FROM exercise where weekday = 'wed'";
                                        ...
                                        <tr>
                                            ...
                                            <td><%=resultSet3.getString("exercise") %></td>
                                            <td><%=resultSet3.getString("des") %></td>
...
<!--                                            <td><b>pageno</b></td>
                                        ...
                                        String sql ="SELECT * FROM exercise where weekday = 'thur'";

                                        resultSet4 = statement.executeQuery(sql);
...
<!--                                            <td><%=resultSet2.getString("pageno") %></td>
                                            ...
                                            <td><%=resultSet4.getString("exercise") %></td>
                                            <td><%=resultSet4.getString("des") %></td>
...
<!--                                            <td><b>pageno</b></td>
                                        ...
                                        String sql ="SELECT * FROM exercise1 where weekday = 'fri'";
...
<!--                                            <td><%=resultSet2.getString("pageno") %></td>
                                            ...
                                            <td><%=resultSet5.getString("exercise") %></td>
                                            <td><%=resultSet5.getString("des") %></td>
...
<!--                                            <td><b>pageno</b></td>
                                        ...
                                        String sql ="SELECT * FROM exercise where weekday = 'sat'";

                                        resultSet6 = statement.executeQuery(sql);
...
<!--                                            <td><%=resultSet2.getString("pageno") %></td>
                                            ...
                                            <td><%=resultSet6.getString("exercise") %></td>
                                            <td><%=resultSet6.getString("des") %></td>
    ...
    <input type="text" value="" id="exc_id">
    
    <div id="exc_options">
        
<!--        <button onclick="selectthis('burpee')">Burpee</button>
        <button onclick="selectthis('burpee')">Burpee</button>
        <button onclick="selectthis('burpee')">Burpee</button>-->
    ...
    <script type="text/javascript">
        ...
        excercises = ['burpee','jump jacks','pushups'];
        
        for(var i=0;i<excercises.length;i++) {
            var button = document.createElement("button");               // Create a <p> element
            button.setAttribute("onclick", "selectthis('"+excercises[i]+"')");
            button.innerText = excercises[i];
            document.getElementById('exc_options').appendChild(button);                      // Append <p> to <body>
        }
        
        function selectthis(exc_name) {
            document.getElementById("exc_id").value = exc_name;
        }
